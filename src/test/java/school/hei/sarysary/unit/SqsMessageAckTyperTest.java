package school.hei.sarysary.unit;
...
import school.hei.sarysary.endpoint.event.EventConsumer;
import school.hei.sarysary.endpoint.event.gen.UuidCreated;
...
public class SqsMessageAckTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent("school.hei.sarysary.endpoint.event.gen.UuidCreated", payload);
