package school.hei.sarysary.endpoint.event;
...
import school.hei.sarysary.repository.DummyUuidRepository;
        ...
        List.of(
            new EventConsumer.AcknowledgeableTypedEvent(
                new EventConsumer.TypedEvent(
                    "school.hei.sarysary.endpoint.event.gen.UuidCreated", payloadReceived),
                () -> {})));
